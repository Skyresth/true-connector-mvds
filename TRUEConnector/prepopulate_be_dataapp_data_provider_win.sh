...
docker rm -f $(docker ps -aq --filter volume=be_dataapp_provider_data) || true

docker volume rm -f be_dataapp_provider_data || true

# Replace 'be_dataapp_provider_data' with the actual volume name you want to create
...
docker run --rm -v "C:\Users\Tales\IdeaProjects\true-connector-mvds\TRUEConnector\be-dataapp_data_provider:/source_data" -v "be_dataapp_provider_data:/target_data" alpine sh -c "cp -r /source_data/* /target_data/datalake/"
